...
def most_spoken_languages(dict):
    all_languages = [lang for country in dict for lang in country['languages']] 
    cout = Counter(all_languages)
    top10 = cout.most_common(10)
    return top10
print(most_spoken_languages(data_countries))

#5.2 Create a function called the most_populated_countries. It should return 10 or 20 most populated countries in descending order.
...
print(most_populated_countries(data_countries))